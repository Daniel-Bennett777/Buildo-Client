  ...
  >
    <div className="mx-auto max-w-screen-md py-6">
      ...
      export const CreateWorkOrderForm = ({ currentUser }) => {
        ...
        const [countyName, setCountyName] = useState("");
        const [description, setDescription] = useState("");
        const [profileImage, setProfileImage] = useState(null); // Update this line
        const [status, setStatus] = useState(1);
        const navigate = useNavigate();
        ...
        const handleSubmit = async (e) => {
          ...
          // Create a new work order object with the form data
          const newWorkOrder = {
            service_type: serviceType,
            state_name: stateName,
            county_name: countyName,
            description: description,
            profile_image: profileImage, // Update this line
            status: status,
          };
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="profileImage"
                    name="profileImage"
                    onChange={(e) => setProfileImage(e.target.files[0])} // Update this line
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-orange-500 leading-tight focus:outline-none focus:shadow-outline"
                    required
                  />
                </div>
